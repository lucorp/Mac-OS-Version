...
update: (output,domEl) ->
  ...
  if (macOSVersion >= 26.0 && macOSVersion < 27)
      if Interface == 'Dark' then icon = iconDir + "tahoe.png" else icon = iconDir + "tahoe.png"
      osRelease = 'Tahoe'
  else if (macOSVersion >= 15.0 && macOSVersion < 16)
